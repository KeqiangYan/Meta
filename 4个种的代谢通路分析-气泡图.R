me<-read.table("Methane_metabolism.txt.out",header = T, sep = "\t")
library(dplyr)
...
ni1<-read.table("Nitrogen_metabolism.txt.out",header = T, sep = "\t")
ni2<-ni1 %>% group_by(Family) %>%
  summarise(sum(S08),sum(S10),sum(S12),sum(S14),sum(S16),sum(S18),sum(S20),sum(S22),sum(S24),sum(S26),sum(S28))
...
ca1<-read.table("carbon_fixation_prokaryotes.txt.out",header = T, sep = "\t")
ca2<-ca1 %>% group_by(Family) %>%
  summarise(sum(S08),sum(S10),sum(S12),sum(S14),sum(S16),sum(S18),sum(S20),sum(S22),sum(S24),sum(S26),sum(S28))
