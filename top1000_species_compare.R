...
cb_palette <-c("#999999","#E69F00","#009E73","#56B4E9","#F0E442","#0072B2","#D55E00","#CC79A7","#999999","#E69F00","#009E73","#56B4E9","#F0E442","#0072B2","#D55E00","#CC79A7","#999999")
...
#高丰度样本的比较
high<-sc2[,c(1,2,3,5,7,8,9,11,13)]
...
dev.off()
#低丰度物种比较
low<-sc2[,-c(2,3,5,7,8,9,11,13)]
l1<-melt(low,id = "Sample")
colnames(l1)<-c("Sample","Species","Abundance")
cb_palette <-c("#999999","#E69F00","#009E73","#56B4E9","#F0E442","#0072B2","#D55E00","#CC79A7","#999999")
